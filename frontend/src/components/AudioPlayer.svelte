...
<script>
    ...
    import PayBackLeftIcon from "../icons/PayBackLeftIcon.svelte"
    import PayBackRightIcon from "../icons/PayBackRightIcon.svelte"
...
<style>
    ...
    progress::-webkit-progress-bar {background-color: var(--secondary-color); width: 100%;border-radius: 20px;}
    progress::-moz-progress-bar { background: var(--primary-color);border-radius: 20px; }
    progress::-webkit-progress-value { background: var(--primary-color);border-radius: 20px; }
    .song-progress {
        width: 100%;
        border-radius: 20px;
        margin-left: 10px;
